  ...
  const articles = [
    {
      ...
      description: "Description of fish disease 1. Symptoms, causes, and treatment options.",
    },
    {
      image: FishImage2,
      title: "Fish Disease 2",
      description: "Description of fish disease 2. Symptoms, causes, and treatment options.",
    },
    {
      image: FishImage3,
      title: "Fish Disease 3",
      description: "Description of fish disease 3. Symptoms, causes, and treatment options.",
    },
    {
      image: FishImage1,
      title: "Fish Disease 1",
          ...
          {articles.map((article, index) => (
            <div key={index} className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
              <img
                ...
                alt={article.title}
              />
              <h2 className="text-2xl font-bold text-center py-4">{article.title}</h2>
              <p className="text-center text-gray-600 px-4">{article.description}</p>
            </div>
          ))}
        </div>
        <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3 mt-16">
          ...
          <div className="my-4">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
              <input
                className="p-3 flex w-full border-[#424242] rounded-md text-black"
                type="email"
