...
const data = {
  regions: {
    ...
    "Region IV‑A – CALABARZON": {
      provinces: {
        "Batangas Province": ["Bauan", "Taal", "Taal", "Taal", "Taal"],
        "Cavite Province": ["Town 7", "Town 8"],
        "Laguna Province": ["Town 7", "Town 8"],
        "Quezon Province": ["Town 7", "Town 8"],
        "Rizal Province": ["Town 7", "Town 8"],
      },
    },
    "MIMAROPA Region": {
      provinces: {
